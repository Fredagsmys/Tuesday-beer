package com.example.teadventskalender;
...
//        target.setTarget("magge123.ddns.net", 1300);
//          target.setTarget("10.0.2.174",1300);
//        target.setTarget("192.168.86.25", 1300);
//        target.setTarget("192.168.1.142", 1303);
        target.setTarget("31.209.53.185", 1304); //RASPBERRYPI RACKARBERGET MED KABEL
    }
